...
public class Logger {
     ...
     *              if the level is TYPE_VERBOSE,you can see all logs,if is TYPE_NONE,you can see
     *              non log
     */
     ...
     * @param stackTrace
     */
    public static void setStackTrace(int stackTrace) {
        LogConfig.STACK_TRACE = stackTrace;
    }

    /**
     * @param enable
     */
    public static void setLineIndicatorEnable(boolean enable) {
        LogConfig.LINE_INDICATOR_ENABLE = enable;
    }
